...
// Define variables and initialize with empty values5631
$username = $password = "";
                    ...
                    <div id="formContent">
                      ...
                      <form>
                        <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                            <input placeholder="Enter your username" type="text" name="username" class="form-control" value="<?php echo $username; ?>">
