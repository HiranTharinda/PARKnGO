...
$query=mysqli_query($link,"select uid from users where uid='$uid' and  password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($link,"update users set password='$newpassword' where uid='$uid'");
